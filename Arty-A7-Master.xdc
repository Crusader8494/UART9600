...
## Pmod Header JA
#set_property -dict {PACKAGE_PIN G13 IOSTANDARD LVCMOS33} [get_ports SerialLine0]
#set_property -dict {PACKAGE_PIN B11 IOSTANDARD LVCMOS33} [get_ports PMOD_JA_02]
#set_property -dict {PACKAGE_PIN A11 IOSTANDARD LVCMOS33} [get_ports PMOD_JA_03]
#set_property -dict {PACKAGE_PIN D12 IOSTANDARD LVCMOS33} [get_ports PMOD_JA_04]
#set_property -dict {PACKAGE_PIN D13 IOSTANDARD LVCMOS33} [get_ports PMOD_JA_05]
#set_property -dict {PACKAGE_PIN B18 IOSTANDARD LVCMOS33} [get_ports PMOD_JA_06]
#set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS33} [get_ports PMOD_JA_07]
#set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports PMOD_JA_08]
...
#set_output_delay -clock [get_clocks sys_clk_pin] -min 30.000 [get_ports PMOD_JA_01]
#set_output_delay -clock [get_clocks sys_clk_pin] -max 120.000 [get_ports PMOD_JA_01]
#set_output_delay -clock [get_clocks sys_clk_pin] -min 30.000 [get_ports PMOD_JA_02]
#set_output_delay -clock [get_clocks sys_clk_pin] -max 120.000 [get_ports PMOD_JA_02]
#set_output_delay -clock [get_clocks sys_clk_pin] -min 30.000 [get_ports PMOD_JA_03]
#set_output_delay -clock [get_clocks sys_clk_pin] -max 120.000 [get_ports PMOD_JA_03]
#set_output_delay -clock [get_clocks sys_clk_pin] -min 30.000 [get_ports PMOD_JA_04]
#set_output_delay -clock [get_clocks sys_clk_pin] -max 120.000 [get_ports PMOD_JA_04]
#set_output_delay -clock [get_clocks sys_clk_pin] -min 30.000 [get_ports PMOD_JA_05]
#set_output_delay -clock [get_clocks sys_clk_pin] -max 120.000 [get_ports PMOD_JA_05]
#set_output_delay -clock [get_clocks sys_clk_pin] -min 30.000 [get_ports PMOD_JA_06]
#set_output_delay -clock [get_clocks sys_clk_pin] -max 120.000 [get_ports PMOD_JA_06]
#set_output_delay -clock [get_clocks sys_clk_pin] -min 30.000 [get_ports PMOD_JA_07]
#set_output_delay -clock [get_clocks sys_clk_pin] -max 120.000 [get_ports PMOD_JA_07]
#set_output_delay -clock [get_clocks sys_clk_pin] -min 30.000 [get_ports PMOD_JA_08]
#set_output_delay -clock [get_clocks sys_clk_pin] -max 120.000 [get_ports PMOD_JA_08]
#create_clock -period 1.000 -name virtual_clock
#set_input_delay -clock [get_clocks virtual_clock] -min 10.000 [get_ports SW0]
#set_input_delay -clock [get_clocks virtual_clock] -max 1000.000 [get_ports SW0]
#set_output_delay -clock [get_clocks virtual_clock] -min 10.000 [get_ports PMOD_JA_01]
#set_output_delay -clock [get_clocks virtual_clock] -max 1000.000 [get_ports PMOD_JA_01]
#set_output_delay -clock [get_clocks virtual_clock] -min 10.000 [get_ports PMOD_JA_02]
#set_output_delay -clock [get_clocks virtual_clock] -max 1000.000 [get_ports PMOD_JA_02]
#set_output_delay -clock [get_clocks virtual_clock] -min 10.000 [get_ports PMOD_JA_03]
#set_output_delay -clock [get_clocks virtual_clock] -max 1000.000 [get_ports PMOD_JA_03]
#set_output_delay -clock [get_clocks virtual_clock] -min 10.000 [get_ports PMOD_JA_04]
#set_output_delay -clock [get_clocks virtual_clock] -max 1000.000 [get_ports PMOD_JA_04]
#set_output_delay -clock [get_clocks virtual_clock] -min 10.000 [get_ports PMOD_JA_05]
#set_output_delay -clock [get_clocks virtual_clock] -max 1000.000 [get_ports PMOD_JA_05]
#set_output_delay -clock [get_clocks virtual_clock] -min 10.000 [get_ports PMOD_JA_06]
#set_output_delay -clock [get_clocks virtual_clock] -max 1000.000 [get_ports PMOD_JA_06]
#set_output_delay -clock [get_clocks virtual_clock] -min 10.000 [get_ports PMOD_JA_07]
#set_output_delay -clock [get_clocks virtual_clock] -max 1000.000 [get_ports PMOD_JA_07]
#set_output_delay -clock [get_clocks virtual_clock] -min 10.000 [get_ports PMOD_JA_08]
#set_output_delay -clock [get_clocks virtual_clock] -max 1000.000 [get_ports PMOD_JA_08]
#set_input_delay -clock [get_clocks virtual_clock] -min 10.000 [get_ports SW1]
#set_input_delay -clock [get_clocks virtual_clock] -max 1000.000 [get_ports SW1]
#set_input_delay -clock [get_clocks virtual_clock] -min 10.000 [get_ports SW2]
#set_input_delay -clock [get_clocks virtual_clock] -max 1000.000 [get_ports SW2]
#set_input_delay -clock [get_clocks virtual_clock] -min 10.000 [get_ports SW3]
#set_input_delay -clock [get_clocks virtual_clock] -max 1000.000 [get_ports SW3]
...
create_clock -period 104170.000 -name Tx_FIFO_Clock -waveform {0.000 52080.000} -add [get_ports CLK100MHz]
create_clock -period 26040.000 -name Rx_FIFO_Clock -waveform {0.000 13020.000} -add [get_ports CLK100MHz]
